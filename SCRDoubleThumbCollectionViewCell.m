...
@interface SCRDoubleThumbCollectionViewCell()
...
@implementation SCRDoubleThumbCollectionViewCell
...
//        [self.thumbBox setBackgroundColor:[UIColor colorWithRed:1.0 green:0.0 blue:0.0 alpha:0.5]];
        ...
        self.thumbView = [[SCRThumbnailLoopView alloc] initWithFrame:CGRectMake(0.0, 0.0, thumbDimension*2, thumbDimension*2)];

        [self.thumbBox addSubview:self.thumbView];
        [self.thumbView constrainWidth:FLKPredicate(thumbDimension*2) height:FLKPredicate(thumbDimension*2)];
...
- (void)layoutSubviews
{
    ...
    [[self.thumbView layer] setBorderColor:(self.productRequestFailed) ? [[UIColor scrapplingForegroundOrangeColor] CGColor] : (self.purchased) ? [[UIColor scrapplingForegroundOrangeColor] CGColor] : [[UIColor scrapplingForegroundGreenColor] CGColor]];

    
//    [[self.thumbView layer] setBorderColor:(self.purchased) ? [[UIColor scrapplingForegroundBlueColor] CGColor] : (self.productRequestFailed) ? [[UIColor scrapplingForegroundOrangeColor] CGColor] : [[UIColor scrapplingForegroundGreenColor] CGColor]];
//    [[self.thumbView layer] setBorderColor:[[UIColor scrapplingForegroundOrangeColor] CGColor]];
    //        [[self.thumbView layer] setBorderColor:[[UIColor scrapplingForegroundBlueColor] CGColor]];
...
//        else
//        {
//            [self.cornerButton setBackgroundImage:nil forState:UIControlStateNormal];
//        }
    }
    else
    {
...
//    [self.cornerButton setBackgroundImage:(!self.purchased) ? [UIImage imageNamed:@"icn_lock"] : (self.favorite) ? [UIImage imageNamed:@"icn_unlocked_fav_on"] : [UIImage imageNamed:@"icn_unlocked_fav_off"] forState:UIControlStateNormal];
